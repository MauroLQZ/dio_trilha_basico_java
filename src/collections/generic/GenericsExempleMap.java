...
public class GenericsExempleMap {
	public static void main(String[] args) {
		...
		System.out.println("COM GENERIC: ");
		System.out.println("(Map.Entry<String, Integer> entry : mapaGenerics.entrySet()) ");
		...
		System.out.println("SEM GENERIC: ");
		System.out.println("(Object obj : mapaSemGenerics.entrySet()) ");
